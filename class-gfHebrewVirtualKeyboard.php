...
<?php }
	...
	public function plugin_page() {
		echo '<p>Feel free to say Thank you to the developers with this donation</p><form action="https://www.paypal.com/donate" method="post" target="_top">
			<input type="hidden" name="hosted_button_id" value="MC9JKUDBANT5C" />
